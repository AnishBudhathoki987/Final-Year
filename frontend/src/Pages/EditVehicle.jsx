  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-[900px] mx-auto px-4 py-10">
        <h1 className="text-3xl font-black text-slate-900">Edit Vehicle</h1>
        ...
        <form onSubmit={onSubmit} className="mt-6 bg-white border border-slate-200 rounded-xl p-6 grid gap-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            {form.type === "rent" ? (
              <Input label="Price Per Day (NPR)" name="pricePerDay" type="number" value={form.pricePerDay} onChange={onChange} required />
            ) : (
              <Input label="Price (NPR)" name="price" type="number" value={form.price} onChange={onChange} required />
            )}
          </div>
          ...
          <label className="grid gap-1">
            ...
            <input className="h-11 rounded-lg border border-slate-200 px-3" name="images" value={form.images} onChange={onChange} />
          </label>

          <label className="grid gap-1">
            <span className="text-sm font-bold text-slate-700">Description</span>
            <textarea className="min-h-28 rounded-lg border border-slate-200 px-3 py-2" name="description" value={form.description} onChange={onChange} />
          </label>
